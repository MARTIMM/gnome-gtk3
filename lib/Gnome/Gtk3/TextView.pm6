...
C<Gnome::Gtk3::TextBuffer>, C<Gnome::Gtk3::TextIter>
...
Creates a new C<Gnome::Gtk3::TextView>. If you don’t call C<gtk_text_view_set_buffer()>
...
Returns: a new C<Gnome::Gtk3::TextView>
...
Creates a new C<Gnome::Gtk3::TextView> widget displaying the buffer
...
=item N-GObject $buffer; a C<Gnome::Gtk3::TextBuffer>
...
to this function, you must remove that reference yourself; C<Gnome::Gtk3::TextView>
will not “adopt” it.

  method gtk_text_view_set_buffer ( N-GObject $buffer )

=item N-GObject $buffer; (allow-none): a C<Gnome::Gtk3::TextBuffer>
...
Returns the C<Gnome::Gtk3::TextBuffer> being displayed by this text view.
The reference count on the buffer is not incremented; the caller
of this function won’t own a new reference.

Returns: (transfer none): a C<Gnome::Gtk3::TextBuffer>
...
=item N-GObject $iter; a C<Gnome::Gtk3::TextIter>
...
=item N-GObject $iter; (allow-none): a C<Gnome::Gtk3::TextIter>
...
=item N-GObject $iter; (out): a C<Gnome::Gtk3::TextIter>
...
Gets the C<Gnome::Gtk3::TextIter> at the start of the line containing
...
=item N-GObject $target_iter; (out): a C<Gnome::Gtk3::TextIter>
...
=item GtkTextWindowType $win; a C<Gnome::Gtk3::TextWindowType> except C<GTK_TEXT_WINDOW_PRIVATE>
...
Retrieves the C<Gnome::Gdk3::Window> corresponding to an area of the text view;
...
Returns: (nullable) (transfer none): a C<Gnome::Gdk3::Window>, or C<Any>
...
views, since they depend on the contents of the C<Gnome::Gtk3::TextBuffer>.
...
Allow the C<Gnome::Gtk3::TextView> input method to internally handle key press
...
and the default key event handling of the C<Gnome::Gtk3::TextView>.

|[<!-- language="C" -->
static gboolean
gtk_foo_bar_key_press_event (C<Gnome::Gtk3::Widget>   *widget,
C<Gnome::Gdk3::EventKey> *event)
{
...
=item GtkTextChildAnchor $anchor; a C<Gnome::Gtk3::TextChildAnchor> in the C<Gnome::Gtk3::TextBuffer> for I<text_view>
...
=item GtkWrapMode $wrap_mode; a C<Gnome::Gtk3::WrapMode>
...
Sets the default editability of the C<Gnome::Gtk3::TextView>. You can override
...
Returns the default editability of the C<Gnome::Gtk3::TextView>. Tags in the
...
Changes the C<Gnome::Gtk3::TextView> overwrite mode.
...
Returns whether the C<Gnome::Gtk3::TextView> is in overwrite mode or not.
...
Returns: a new C<Gnome::Gtk3::TextAttributes>
...
will be a C<Gnome::Gtk3::Menu> in this case.

If prop C<populate-all> is C<1>, this signal will
also be emitted to populate touch popups. In this case,
I<popup> will be a different container, e.g. a C<Gnome::Gtk3::Toolbar>.

The signal handler should not make assumptions about the
type of I<widget>, but check whether I<popup> is a C<Gnome::Gtk3::Menu>
or C<Gnome::Gtk3::Toolbar> or another kind of container.
...
The C<Gnome::GObject::Value> type of property I<left-margin> is C<G_TYPE_INT>.
...
The C<Gnome::GObject::Value> type of property I<right-margin> is C<G_TYPE_INT>.
...
The C<Gnome::GObject::Value> type of property I<top-margin> is C<G_TYPE_INT>.
...
The C<Gnome::GObject::Value> type of property I<bottom-margin> is C<G_TYPE_INT>.
...
The C<Gnome::GObject::Value> type of property I<input-purpose> is C<G_TYPE_ENUM>.
...
The C<Gnome::GObject::Value> type of property I<input-hints> is C<G_TYPE_FLAGS>.
