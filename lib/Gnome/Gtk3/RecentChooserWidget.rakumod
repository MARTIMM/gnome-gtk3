...
Inheriting is done in a special way in that it needs a call from new() to get the native object created by the class you are inheriting from.
  ...
  use Gnome::Gtk3::RecentChooserWidget:api<1>;
...
#-------------------------------------------------------------------------------
unit class Gnome::Gtk3::RecentChooserWidget:auth<github:MARTIMM>:api<1>;
also is Gnome::Gtk3::Box;
also does Gnome::Gtk3::RecentChooser;
...
submethod BUILD ( *%options ) {
  ...
  if self.^name eq 'Gnome::Gtk3::RecentChooserWidget' #`{{ or %options<GtkRecentChooserWidget> }} {
    ...
    self._set-class-info('GtkRecentChooserWidget');
