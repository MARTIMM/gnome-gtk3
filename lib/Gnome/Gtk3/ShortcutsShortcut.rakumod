...
Create a new ShortcutsShortcut object.
...
The size group for the accelerator portion of this shortcut.
   ...
   * This is used internally by GTK+, and must not be modified by applications.Widget type: GTK_TYPE_SIZE_GROUP

The B<Gnome::GObject::Value> type of property I<accel-size-group> is C<G_TYPE_OBJECT>.

=comment -----------------------------------------------------------------------
=comment #TP:0:accelerator:
=head3 Accelerator: accelerator


The accelerator(s) represented by this object. This property is used
if  I<shortcut-type> is set to B<Gnome::Gtk3::TK_SHORTCUT_ACCELERATOR>.

The syntax of this property is (an extension of) the syntax understood by
C<gtk_accelerator_parse()>. Multiple accelerators can be specified by separating
...
Examples:
=item A single shortcut: <ctl><alt>delete=item Two alternative shortcuts: <shift>a Home=item A range of shortcuts: <alt>1...<alt>9=item Several keys pressed together: Control_L&Control_R=item A sequence of shortcuts or keys: <ctl>c+<ctl>x   *
...
=comment -----------------------------------------------------------------------
=comment #TP:0:action-name:
=head3 Action Name: action-name


A detailed action name. If this is set for a shortcut
of type C<GTK_SHORTCUT_ACCELERATOR>, then GTK+ will use
the accelerators that are associated with the action
via C<gtk_application_set_accels_for_action()>, and setting
 I<accelerator> is not necessary.
...
is used regardless of the text direction, set this property to
   * B<Gnome::Gtk3::TK_TEXT_DIR_NONE>.Widget type: GTK_TYPE_TEXT_DIRECTION
...
An icon to represent the shortcut or gesture. This property is used if
 I<shortcut-type> is set to B<Gnome::Gtk3::TK_SHORTCUT_GESTURE>.
   * For the other predefined gesture types, GTK+ provides an icon on its own.Widget type: G_TYPE_ICON

The B<Gnome::GObject::Value> type of property I<icon> is C<G_TYPE_OBJECT>.

=comment -----------------------------------------------------------------------
=comment #TP:0:icon-set:
