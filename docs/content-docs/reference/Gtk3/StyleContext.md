...
Adds a global style provider to *screen*, which will be used in style construction for all `Gnome::Gtk3::StyleContext`s under *screen*.
...
While any widget defining a “search” class would be matched by: |[ .search { ... } ]|
