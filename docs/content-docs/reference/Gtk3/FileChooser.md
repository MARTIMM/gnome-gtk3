...
|[<!-- language="C" --> static **Gnome::Gtk3::FileChooserConfirmation** confirm_overwrite_callback (**Gnome::Gtk3::FileChooser** *chooser, gpointer data) { char *uri;
